const jokeArr = [
    ...
    "Dear Math, \nIm sick and tired of finding your ex just accept that she is gone. Move on dude",
    "Work like a docta!",
...
const toggleSwitch = document.querySelector('[data-switch]'),
    ...
    theQuote = document.querySelector('[data-setup]');
...
btn.addEventListener('click', () =>{
    getRandomInt(0, jokeArr.length);
    theQuote.innerHTML = jokeArr[num];
})
